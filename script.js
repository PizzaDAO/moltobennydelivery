...
;
  ...
  function updateMapStats_() {
    if (!mapResult || !mapCounter) return;
    ...
    // Match the "result + counter" structure (two stacked <p> tags).
    mapResult.textContent = `Distance: ${distText} • First Guess: ${firstText}`;
    mapCounter.textContent = `Attempts: ${attemptCount}`;
  }
